...
public class TextureAtlas 
{
    ...
    /// </summary>
    /// <param name="name">The name to give the texture region.</param>
    /// <param name="position">The position of the region boundary relative to the top-left corner of the source texture boundary.</param>
    /// <param name="dimensions">The dimensions, in pixels, of the region.</param>
    public void AddRegion(string name, Point position, Point dimensions)
    {
        TextureRegion region = new(Texture, position, dimensions);
        _regions.Add(name, region);
    }
