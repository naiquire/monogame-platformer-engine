...
namespace MonoLibrary.Graphics.Textures;
...
public class TextureRegion 
{
    ...
    /// </summary>
    /// <param name="texture">The texture to use as the source texture for this texture region.</param>
    /// <param name="position">The position of the upper-left corner of this texture region relative to the upper-left corner of the source texture.</param>
    /// <param name="dimensions">The dimensions, in pixels, of this texture region.</param>
    public TextureRegion(Texture2D texture, Point position, Point dimensions)
    {
        Texture = texture;
        SourceRectangle = new Rectangle(position, dimensions);
    }
