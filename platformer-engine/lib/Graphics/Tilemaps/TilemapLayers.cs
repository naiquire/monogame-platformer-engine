...
public class TilemapLayers(List<Tilemap> Layers)
{
    /// <summary>
    ...
    /// <returns></returns>
    public static TilemapLayers FromFile(ContentManager content, string filename)
    {
        ...
        return new TilemapLayers(level);
    }
